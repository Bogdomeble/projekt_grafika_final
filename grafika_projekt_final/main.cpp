...
int main() {
	...
	ceiling->modelMatrix = glm::translate(ceiling->modelMatrix, glm::vec3(0.0f, galleryHeight, 0.0f)); // Position ceiling at the top
	ceiling->modelMatrix = glm::rotate(ceiling->modelMatrix, glm::radians(180.0f), glm::vec3(1.0f, 0.0f, 0.0f)); // Rotate ceiling to face downwards
    ...
    createWall(glm::vec3(0.0f, galleryHeight / 2.0f, -galleryDepth / 2.0f), glm::vec3(90.0f, 0.0f, 0.0f), galleryWidth, galleryHeight, glm::vec2(5.0f, 2.0f)); // back
    createWall(glm::vec3(-galleryWidth / 2.0f, galleryHeight / 2.0f, 0.0f), glm::vec3(90.0f, 180.0f, 90.0f), galleryDepth, galleryHeight, glm::vec2(6.0f, 2.0f)); // left
    createWall(glm::vec3(galleryWidth / 2.0f, galleryHeight / 2.0f, 0.0f), glm::vec3(90.0f, 180.0f, -90.0f), galleryDepth, galleryHeight, glm::vec2(6.0f, 2.0f)); // right
    createWall(glm::vec3(0.0f, galleryHeight / 2.0f, galleryDepth / 2.0f), glm::vec3(90.0f, 180.0f, 180.0f), galleryWidth, galleryHeight, glm::vec2(5.0f, 2.0f)); // front
    ...
    if (metalTexture.ID != 0) sculpture->setTexture(&WorldTexture);
    ...
    glm::vec3 pointLightPosition = glm::vec3(0.0f, galleryHeight - 0.0f, 0.0f); // Central ceiling light
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glClearColor(0.05, 0.86, 0.86, 1.0f);
		...
		camera.printData(); // Optional: Print camera data for debugging
